...
import com.easarrive.aws.plugins.cloudsearch.service.impl.Replys4CloudSearchDataCallBacker;
 ...
 *
 */
public class ReplysCloudSearch4DocumentsService extends AbstractCloudSearch4DocumentsService {

    @Autowired
    private IReply4CloudSearchReadMapper reply4CloudSearchReadMapper;

    public ReplysCloudSearch4DocumentsService(String regionName, String searchEndpoint, String docEndpoint, String idFieldName, String indexTimeFieldName) {
    ...
    public UploadDocumentsResult uploadDocuments4Domain() {
        ...
        try {
            ...
            List<Map<String, Object>> dbMap = reply4CloudSearchReadMapper.getReplyIds4Update(lastUpdateTime);
            ...
            List<Reply4CloudSearch> reply4CloudSearchList = reply4CloudSearchReadMapper.getAll(idSet.toArray(new String[0]));
            this.uploadData2AWSCloudSearchAdd(this.getRegion(), indexTime, CloudSearchOptionType.ADD, this.getDocEndpoint(), reply4CloudSearchList, cloudSearchDataCallBacker);
        } catch (Exception e) {
