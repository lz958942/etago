 ...
 *
 */
public class ThumborImageUsersReadDao extends AbstractDaoByRedisTemplate<String, String, String> implements IThumborReadDao<String, String> {

    @Override
    public String get(String key) {
        return this.hashGet(Constant.Thumbor.Path.Image.USERS, key);
    }

    @Override
    public Set<String> allKeys() {
        return this.hashKeys(Constant.Thumbor.Path.Image.USERS);
    }
