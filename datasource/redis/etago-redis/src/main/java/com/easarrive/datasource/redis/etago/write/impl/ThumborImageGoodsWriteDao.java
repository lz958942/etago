 ...
 *
 */
public class ThumborImageGoodsWriteDao extends AbstractDaoByRedisTemplate<String, String, String> implements IThumborWriteDao<String, String> {

    @Override
    public void save(String key, String bean) {
        this.hashPut(Constant.Thumbor.Path.Image.GOODS, key, bean);
    }

    @Override
    public Long delete(String key) {
        return this.hashDelete(Constant.Thumbor.Path.Image.GOODS, key);
    }
}
